...
public class APISunatDocumentos {
    @PostMapping("/consultaRucSunat")
	public ResponseEntity<?> procesarBotonRuc(/*@RequestParam("tipo_documento") Integer tipoDocumento,*/
	...
	@PostMapping("/consultaDniSunat")
	public ResponseEntity<?> procesarBotonDni(/*@RequestParam("tipo_documento") Integer tipoDocumento,*/
			@RequestParam("numero_documento") String numeroDocumento, Model model) {
		/*String tipoConsulta = (tipoDocumento == 6 ? "ruc" : "dni");*/
		String apiUri = "https://api.apis.net.pe/v2/reniec/dni" ;/*+ (tipoDocumento == 6 ? "sunat/" : "/reniec/");*/
		String apiConsulta = apiUri /*+ tipoConsulta */+ "?numero=" + numeroDocumento;
		HttpHeaders headers = new HttpHeaders();
		headers.set("Authorization", "Bearer " + "apis-token-7967.jnTYhcOrD2QCmx87khoUgnFWgfBhJ7-J");
		HttpEntity<String> entity = new HttpEntity<>(null, headers);
